...
export function CodeBlock({ code }: CodeBlockProps) {
  ...
  return (
    <div className="relative rounded-xl overflow-hidden" style={{ border: '1px solid var(--border-input)' }}>
      <div
        className="overflow-auto text-xs font-mono leading-relaxed p-4"
        style={{ background: 'var(--bg-base)', color: '#d4d4d4', maxHeight: '320px' }}
      ...
      <button
        ...
        style={
          copied
            ? { backgroundColor: 'rgba(45,212,191,0.15)', color: 'var(--accent)', border: '1px solid rgba(45,212,191,0.3)' }
            : { backgroundColor: 'rgba(255,255,255,0.05)', color: 'var(--text-muted)', border: '1px solid rgba(255,255,255,0.08)' }
        }
        onMouseEnter={(e) => {
          if (!copied) {
