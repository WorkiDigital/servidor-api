...
import { LayoutDashboard, Settings, Users, LogOut, Menu, Activity, BarChart2, ListTree, Plug, Store, Package, Sun, Moon, Plus, ChevronDown } from 'lucide-react';
...
export function Layout({ children }: LayoutProps) {
  ...
  const nav: NavItem[] = targetId
    ? [
        ...
        { label: 'Integrações', icon: <Plug size={16} />, to: `/hub/projects/${targetId}/integrations` },
        { label: 'Plataformas', icon: <Store size={16} />, to: `/hub/projects/${targetId}/platforms` },
        { label: 'Instalação', icon: <Package size={16} />, to: `/hub/projects/${targetId}/install` },
